...
<head>
    ...
    <title>Proposer un trajet - Covoiturage CE</title>
            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-4">
                        <h2 class="mb-4 text-primary fw-bold">➕ Proposer un nouveau trajet</h2>
                        
                        <form action="/trajet/creer" method="POST">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="id_agence_depart" name="id_agence_depart" required>
                                        ...
                                        <?php foreach ($agences as $agence): ?>
                                            <option value="<?= $agence['id_agence'] ?>"><?= htmlspecialchars($agence['nom_agence']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="id_agence_arrivee" class="form-label fw-bold text-secondary">Agence d'arrivée (Destination)</label>
                            ...
                            <div class="mb-4 col-md-4">
                                <label for="places_totales" class="form-label fw-bold text-secondary">Nombre de places totales</label>
                                <input type="number" class="form-control" id="places_totales" name="places_totales" min="1" max="8" value="4" required>
                            </div>

                            <div class="d-flex justify-content-end gap-2">
                                <a href="/" class="btn btn-light fw-bold px-4">Annuler</a>
                                <button type="submit" class="btn btn-primary fw-bold px-4">Publier le trajet</button>
                            </div>
                        </form>
                    </div>
                </div>
